#ifndef AZGARD_TYPE_TRAITS
#define AZGARD_TYPE_TRAITS
...
template<typename T>
  struct isReference
  : public Or<isLeftValueReference<T>,
                  isRightValueReference<T>>::type
  { };
